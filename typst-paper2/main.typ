...
#place(bottom + center,
      float: true)[
  #show: box.with(width: 100%) // use two column width
  #figure(
...
https://typst.app/team/am-QQl4B8PoLAEEEyn2wLc
