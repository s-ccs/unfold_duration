...
# ╔═╡ f0507e22-c9aa-11ee-2476-4da3edf16e4c
begin
...
# ╔═╡ 67a036ae-ea7d-46fb-876c-57702e479aef
...
# ╔═╡ 44c6492f-4082-43d1-96e3-32b0a605195a
begin
...
begin
	...
	# Panel A
	ax_2x2_1 = Axis(fig_2x2[rows[1]...,cols[1]...], xgridvisible = false, 
		ygridvisible = false, 
	...
	# Panel C
	ax_2x2_3 = Axis(fig_2x2[rows[1]...,cols[2]...], 
		xgridvisible = false, 
		yticksvisible = ytickvis, 
		ygridvisible = false, 
		xticklabelsvisible = false, 
	...
	# Panel D
	ax_2x2_4 = Axis(fig_2x2[rows[2]...,cols[2]...], xgridvisible = false,
	    ygridvisible = false, 
		xticklabelsvisible = false, 
		xticksvisible = false, 
		yticksvisible = ytickvis, 
...
begin 
	# Add labels/ svgs
	ax_2x2_12 = Axis(fig_2x2[rows[2]...,cols[1]...], width=Relative(1), height=Relative(0.25), halign=0.0, valign=0.,limits=((0,1),(-0.5,2.5)))
...
manifest_format = "2.0"
project_hash = "3ae858171f4de4737ae81fef63fb36fcfc8cca11"
